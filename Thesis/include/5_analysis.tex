...
\begin{figure}[htbp]
  \centering
  \subfloat[Average RMSE during training and validation]{\includegraphics[width=0.7\textwidth]{Figures/Plot_AblationStudy_MultiPhaseFT.png}\label{fig:CurveRMSE}}
  \hfill
...
\begin{table}[htbp]
\caption[Results of the proposed approach]{This table presents the achieved results with the proposed approach.}
\begin{center}
\begin{tabular}{@{}lcccc@{}}
\toprule
...
\begin{table}[H]
\caption[State-of-the-art methods]{In the table, state-of-the-art results are compared to the approach of this work. The emotion recognition approach 'CNN+LSTM' proposed by \citet{Theagarajan:2018:DeepDriver} performs best on all selected criteria.}
\begin{center}
\begin{tabular}{@{}lcccc@{}}
\toprule
 Methods & \begin{tabular}[c]{@{}c@{}}RMSE $\downarrow$\\ Valence\end{tabular} & \begin{tabular}[c]{@{}c@{}}RMSE $\downarrow$\\ Arousal\end{tabular} & \begin{tabular}[c]{@{}c@{}}CORR $\uparrow$\\ Valence\end{tabular} & \begin{tabular}[c]{@{}c@{}}CORR $\uparrow$\\ Arousal\end{tabular} \\ \midrule
